...
mixin _$RegisterState {
  ...
  Option<Either<AuthFailure, Unit>> get failure =>
      throw _privateConstructorUsedError;
  Option<ValueFailure> get nameFailure => throw _privateConstructorUsedError;
...
abstract class $RegisterStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      Option<Either<AuthFailure, Unit>> failure,
...
class _$_RegisterState implements _RegisterState {
  ...
  @override
  final Option<Either<AuthFailure, Unit>> failure;
  @override
  ...
  @override
  String toString() {
    return 'RegisterState(validationErrorVisibility: $validationErrorVisibility, failure: $failure, nameFailure: $nameFailure, emailFailure: $emailFailure, passwordFailure: $passwordFailure, name: $name, email: $email, password: $password, isLoading: $isLoading)';
  }
...
abstract class _RegisterState implements RegisterState {
  const factory _RegisterState(
      ...
      required final Option<Either<AuthFailure, Unit>> failure,
      required final Option<ValueFailure> nameFailure,
